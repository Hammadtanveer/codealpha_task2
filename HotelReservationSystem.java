...
public class HotelReservationSystem {
    ...
    public static void main(String[] args) {
        initializeRooms();
        System.out.println("Welcome to the Khan Hotel Reservation System!");
    ...
    private static void initializeRooms() {
        ...
        rooms.add(new Room(101, "Standard", true, 150));
        rooms.add(new Room(102, "Deluxe", true, 200));
        rooms.add(new Room(103, "Suite", true, 300));
        rooms.add(new Room(201, "Standard", true, 150));
        rooms.add(new Room(202, "Deluxe", true, 200));
        rooms.add(new Room(203, "Suite", false, 300)); // Booked room
    }
